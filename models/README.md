...
|-------|--------|-------------|
| 1 | 01_training | Train the model on the Argens basin and test it with hel-out test set |
| 2 | 02_prediction | Predict target raster using trained model on input selected datasets |
