...
MODEL_DIR = RESULTS_DIR / "random_forest"
MODEL_PATH = MODEL_DIR / "rf_model_4dtsts.pkl"
...
def train_random_forest(X, y, param_grid, seed=42):
    """
...
def main():
    ...
    corr_fig_path = FIGURES_DIR / "rf_correlation_matrix.png"
    ...
    rf_search = train_random_forest(X_train, y_train, param_grid, RANDOM_SEED)
