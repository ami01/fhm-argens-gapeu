"""
XGBoost — Validation (Argens Basin)

Validates XGB predictions against ground truth points.
...
# ── Paths ───────────────────────────────────────────────
PREDICTION_RASTER = RESULTS_DIR / "xgboost" / "XGB_4dtsts_prediction.tif"
...
def main():
    print("=" * 60)
    print("XGBOOST — VALIDATION (ARGENS)")
    print("=" * 60)
    ...
    print_metrics(metrics, "XGBoost — Argens Validation")
    ...
    plot_roc_curve(
        ...
        tpr=metrics['tpr'],
        auc=metrics['auc'],
        model_name="XGBoost — Argens",
        color='green',
        save_path=FIGURES_DIR / "xgb_validation_roc.png"
    )
